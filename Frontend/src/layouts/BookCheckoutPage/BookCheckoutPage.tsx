...
export const BookCheckoutPage = () => {
    ...
    const bookId = (window.location.pathname).split('/')[2]; //give the url and its values as a string
    ...
    if (isLoading || isLoadingReview || isLoadingCurrentLoansCount || isLoadingUserReview || isLoadingBookCheckout) {
        return (
            <SpinnerLoading />
        )
    }
